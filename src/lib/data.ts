...
export const noiseSlides: Slide[] = [
    ...
    { title: "Límites de Exposición en Guatemala", content: "El Reglamento de SSO de Guatemala (Art. 230) establece un Nivel de Acción de 85 dBA para 8 horas.\nAl alcanzar este nivel, el patrono debe implementar un Programa de Conservación Auditiva. El Límite Permisible de Exposición es de 90 dBA.", icon: "Gauge" },
    { title: "Normativa y Estándares de Referencia", content: "La normativa guatemalteca se alinea con estándares internacionales como los de OSHA (EE.UU.).\nLa recomendación de 85 dBA de ACGIH es un estándar de referencia clave en la higiene industrial moderna para proteger a la mayoría de los trabajadores.", icon: "Globe" },
...
export const noiseQuiz: QuizQuestion[] = [
  ...
  { q: "Según el Reglamento de SSO de Guatemala, ¿a partir de qué nivel se debe implementar un programa de conservación auditiva?", a: 0, opts: ["85 dBA", "90 dBA", "100 dBA"], exp: "El Artículo 230 establece el Nivel de Acción en 85 dBA para 8 horas, momento en el que se requiere acción por parte del patrono." },
...
export const particulateSlides: Slide[] = [
    ...
    { title: "Límites de Exposición en Guatemala", content: "El Reglamento de SSO (Art. 238) adopta los TLV® de la ACGIH como límites de exposición profesional.\nPara la sílice cristalina (una de las más peligrosas), el límite es extremadamente bajo: 0.025 mg/m³, reflejando su alta toxicidad.", icon: "AlertTriangle" },
